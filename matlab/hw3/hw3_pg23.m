...
%% p23
% L1 : 0.425, L2 : 0.392, W1 : 0.109, W2 : 0.082, H1 : 0.089, H2 : 0.095
L1 = 0.425;
L2 = 0.392;
W1 = 0.109;
W2 = 0.082;
...
disp("-------------------");
disp("p23");
disp("For spatial theta( 1 2 3 4 5 6 )=>( 0 -pi/2 0 0 pi/2 0 )");
disp("T_final in spatial twist");
disp(T_final_s);
disp("For body theta( 1 2 3 4 5 6 )=>( 0 -pi/2 0 0 pi/2 0 )");
